 ...
 *
 * Examples:
 * [_unit, 1000] call kyt_common_fnc_paradrop; // Unit will drop from 1000m and pull chute at 60m
 * [_unit, 1000, 100] call kyt_common_fnc_paradrop; // Unit will drop from 1000m and pull chute at 100m
 *
 * Public: No
*/
