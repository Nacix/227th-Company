class CfgVehicles
{
    ...
    SUBCLASS(B_Krayt_P2_Engineer_F,JLTS_Clone_P2_eod)
    {
        ...
        // Equipment
        #undef EQUIPMENT
        #define EQUIPMENT { CLASS(H_Engineer_Trooper), CLASS(V_AB_EOD), CLASS(NV_Internal), QUOTE(JLTS_clone_comlink), EQUIPMENT_BASE }
    ...
    SUBCLASS(B_Krayt_Insulated_DC15A_F,TAG_CLASS(B_Krayt_P2_DC15A_F))
    {
        ...
        // Equipment
        #undef EQUIPMENT
        #define EQUIPMENT { CLASS(H_Insulated_Trooper), CLASS(V_Invisible_CT), CLASS(NV_Internal), QUOTE(JLTS_clone_comlink), EQUIPMENT_BASE }
    ...
    SUBCLASS(B_Krayt_Insulated_Marksman_F,TAG_CLASS(B_Krayt_P2_Marksman_F))
    {
        ...
        // Equipment
        #undef EQUIPMENT
        #define EQUIPMENT { CLASS(H_Insulated_Trooper), CLASS(V_Invisible_CT), CLASS(NV_Macro_Brown_spec), QUOTE(JLTS_clone_comlink), EQUIPMENT_BASE }
