...
class CfgPatches
{
    class ADDON
    {
        ...
        units[]=
        {
            ...
            CLASS(B_Krayt_ARC_WestarM5_F),
            CLASS(B_Krayt_ARC_AT_F),
            CLASS(B_Krayt_ARC_Engineer_F),
            CLASS(B_Krayt_ARC_Medic_F),
            CLASS(B_Krayt_ARC_Sharpshooter_F),
            CLASS(B_Krayt_ARC_Sniper_F),
            CLASS(B_Krayt_ARC_NCO_F),
            CLASS(B_Krayt_P1_DC15A_F),
            CLASS(B_Krayt_P1_DC15S_F),
            CLASS(B_Krayt_P1_AT_F),
            CLASS(B_Krayt_P1_DC15A_UGL_F),
            CLASS(B_Krayt_P1_CP_F),
            CLASS(B_Krayt_P1_CS_F),
            CLASS(B_Krayt_P1_CSM_F),
            CLASS(B_Krayt_P1_CLT_F),
            CLASS(B_Krayt_P1_CPT_F),
            CLASS(B_Krayt_P1_CC_F),
            CLASS(B_Krayt_P1_Engineer_F),
            CLASS(B_Krayt_P1_Engineer_NCO_F),
            CLASS(B_Krayt_P1_Medic_F),
            CLASS(B_Krayt_P1_RTO_F),
            CLASS(B_Krayt_P1_Support_F),
            CLASS(B_Krayt_P1_Sniper_F),
            ...
            CLASS(B_Krayt_Jet_Marksman_F),
            CLASS(B_Krayt_Jet_Sniper_F),
            ...
            CLASS(B_Krayt_Geonosis_Sniper_F),
            ...
            CLASS(B_Krayt_Insulated_Sniper_F)
        };
        magazines[] = {};
        ammo[] = {};
    };
