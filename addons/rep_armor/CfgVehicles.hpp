class CfgVehicles
{
	...
	ADD_HELMET_OBJECT_PILOT(P1 Pilot Helmet (CX),CX);
	ADD_HELMET_OBJECT_PILOT(P1 Pilot Helmet (CXG1),CXG1);
	ADD_HELMET_OBJECT_PILOT(P1 Pilot Helmet (CXG2),CXG2);

	ADD_HELMET_OBJECT_PILOT(P2 Pilot Helmet (CX),CX);
	ADD_HELMET_OBJECT_PILOT(P2 Pilot Helmet (Carrot),Carrot);
	ADD_HELMET_OBJECT_PILOT(P2 Pilot Helmet (Texan),Texan);
};