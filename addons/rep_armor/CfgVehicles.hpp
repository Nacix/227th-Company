class CfgVehicles
{
	...
	ADD_HELMET_OBJECT_P2(P2 Helmet (CLP),H_P2_CLP);
	...
	ADD_HELMET_OBJECT_P2(P2 EOD Helmet,H_P2_EOD);
	ADD_HELMET_OBJECT_P2(P2 EOD Helmet (CSP),H_P2_EOD_CSP);
	ADD_HELMET_OBJECT_P2(P2 EOD Helmet (NCO),H_P2_EOD_NCO);
