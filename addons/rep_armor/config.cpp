...
class CfgPatches
{
    class ADDON
    {
        ...
        units[]=
        {
            ...
            CLASS(Headgear_H_P2_EOD),
            CLASS(Headgear_H_P2_EOD_CSP),
            CLASS(Headgear_H_P2_EOD_NCO),
            CLASS(Headgear_H_P2_Canada),
            CLASS(Headgear_H_P2_Catcher),
            CLASS(Headgear_H_P2_FiveO),
            CLASS(Headgear_H_P2_Fox),
            CLASS(Headgear_H_P2_Hotshot),
            CLASS(Headgear_H_P2_Jager),
